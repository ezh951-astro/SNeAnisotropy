...
#label=r'log10 Gas Column Density [${\rm M}_{\odot}$ ${\rm pc}^{-2}$]', labelsize=16)
...
#label=r'log10 Stellar Column Density [${\rm M}_{\odot} ${\rm pc}^{-2}$]', labelsize=16 )

#cbar0.ax.set_label( r'log10 Gas Column Density [${\rm M}_{\odot}$ ${\rm pc}^{-2}$]' )
#cbar4 = fig4.colorbar( imEdge4, ax=axs4, shrink=0.9)
#cbar4.ax.set_label( r'log10 Stellar Column Density [${\rm M}_{\odot}$ ${\rm pc}^{-2}$]' )

#cbar0.ax.yticks([-2,-1,0,1,2,3])
...
fig0.savefig('OfficialPaperPlots/F6-GasMap')
fig4.savefig('OfficialPaperPlots/F7-StarMap')
