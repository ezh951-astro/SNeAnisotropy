...
def gas_code_to_cgs_density(rho, xh=0.76  ):
#        nn = xh*rho*1.99e43/(3.08e21)**3/1.66e-24*(hubble**2)/(aexp**3)
    return rho * xh * units.constants["UnitMass_in_g"]/units.constants["UnitDist_in_cm"]**3/units.constants["PROTONMASS"] 
